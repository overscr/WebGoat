...
public class LogBleedingTask implements AssignmentEndpoint {
  ...
  public LogBleedingTask() {
    ...
    // The administrator's password used to be written to the application log at start-up,
    // base64 wrapped, which is encoding rather than protection: anyone who can read the log
    // holds the credential. Secrets are not logged, in any encoding.
    log.info("Administrator credentials initialised");
  }
